...
const navigation = [
    ...
    { label: 'Squad', icon: Shirt },
    { label: 'Tactics', icon: Shield },
    { label: 'Competitions', icon: Trophy },
    { label: 'Schedule', icon: CalendarDays },
    { label: 'Transfers', icon: CircleDollarSign },
];
    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-[#eef1f5] text-slate-900">
                <aside className="fixed inset-y-0 left-0 hidden w-64 flex-col bg-[#101b2d] text-slate-300 lg:flex">
                    <div className="flex h-20 items-center gap-3 border-b border-white/10 px-6">
                        <div className="flex size-10 items-center justify-center rounded-xl bg-emerald-400 text-[#101b2d]">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-semibold tracking-[0.2em] text-emerald-400">
                                MANAGER
                            </p>
                        </div>
                    </div>
                    ...
                    <nav className="flex-1 space-y-1 px-3 py-6">
                        {navigation.map(({ label, icon: Icon, active }) => (
                            <button
                                type="button"
                                key={label}
                                className={`flex w-full items-center gap-3 rounded-lg px-4 py-3 text-sm font-medium transition ${active ? 'bg-emerald-400 text-[#101b2d]' : 'hover:bg-white/5 hover:text-white'}`}
                            >
                                <Icon size={19} />
                                {label}
                            </button>
                    ...
                    <div className="border-t border-white/10 p-3">
                        <button
                            type="button"
                            className="flex w-full items-center gap-3 rounded-lg px-4 py-3 text-sm font-medium hover:bg-white/5 hover:text-white"
                        >
                            <Settings size={19} />
                            Settings
                        </button>
                ...
                <div className="lg:pl-64">
                    <header className="sticky top-0 z-10 flex h-20 items-center justify-between border-b border-slate-200 bg-white/90 px-5 backdrop-blur sm:px-8">
                        <div className="flex items-center gap-3 lg:hidden">
                            <div className="flex size-9 items-center justify-center rounded-lg bg-emerald-400 text-[#101b2d]">
                                <Trophy size={19} />
                            </div>
